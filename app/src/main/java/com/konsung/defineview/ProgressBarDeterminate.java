...
public class ProgressBarDeterminate extends CustomView {
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        min = attrs.getAttributeIntValue(KONSUNG, "min", 0);
        max = attrs.getAttributeIntValue(KONSUNG, "max", 100);
        progress = attrs.getAttributeIntValue(KONSUNG, "progress", min);

        setMinimumHeight(UiUitls.dpToPx(3, getResources()));
    ...
    public void setBackgroundColor(int color) {
        ...
        GradientDrawable shape = (GradientDrawable) layer.findDrawableByLayerId(
                R.id.shape_bacground);
