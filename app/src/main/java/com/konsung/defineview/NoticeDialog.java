...
public class NoticeDialog extends Dialog {
    ...
    public interface UpdataButtonState {
        /**
         * 回调方法
         * @param updateMessage app类型信息
         * @param pressed 确定安装更新
         */
        public void getButton(Boolean pressed, UpdateMessage updateMessage);
    }
     ...
     */
    public NoticeDialog(Context context, String title, UpdataButtonState updataButtonState
        ...
        btnCommit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentTime - lastClickTime > MIN_CLICK_DELAY_TIME) {
                    updataButtonState.getButton(true, updateMessage);
                }
                dismiss();
                hide();
            }
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentTime - lastClickTime > MIN_CLICK_DELAY_TIME) {
                    ...
                    updataButtonState.getButton(false, updateMessage);
                }
                hide();
            }
        });
