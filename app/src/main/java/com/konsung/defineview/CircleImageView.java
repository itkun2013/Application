...
public class CircleImageView extends ImageView {
    ...
    /**
     * 设置背景颜色
     * @param circleBackgroundColor 背景色
     */
    ...
    /**
     * 设置背景图片
     * @param circleBackgroundRes 背景资源
     */
    ...
    /**
     * 设置是否为圆形图片
     * @param disableCircularTransformation 设置值
     */
    ...
    private void updateShaderMatrix() {
        ...
        if (mBitmapWidth * mDrawableRect.height() > mDrawableRect.width() * mBitmapHeight) {
            ...
            dx = (mDrawableRect.width() - mBitmapWidth * scale) * value;
        } else {
            scale = mDrawableRect.width() / (float) mBitmapWidth;
            dy = (mDrawableRect.height() - mBitmapHeight * scale) * value;
        }
        mShaderMatrix.setScale(scale, scale);
        mShaderMatrix.postTranslate((int) (dx + value) + mDrawableRect.left
                , (int) (dy + value) + mDrawableRect.top);
