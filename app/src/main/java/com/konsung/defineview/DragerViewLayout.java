...
import com.konsung.util.SharedPreferencesUtil;
...
//                        View view = LayoutInflater.from(mContext).inflate(R.layout.main, null);
//                        ((RelativeLayout) child).addView(view);
//                    }
                    return true;
                }
...
//                    if (releasedChild instanceof RelativeLayout) {
//                        ((RelativeLayout) releasedChild).removeViewAt(1);
//                    }
                }
