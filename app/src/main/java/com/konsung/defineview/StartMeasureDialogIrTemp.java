 ...
 */
public abstract class StartMeasureDialogIrTemp extends Dialog {
     ...
     */
    public StartMeasureDialogIrTemp(Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_start_measure_ir_temp);

        ButterKnife.inject(this);
        dialog_pb = (ProgressBarDeterminate) findViewById(R.id.irtemp_dg_pb);
...
//        });
        ...
        anim.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                contentView.post(new Runnable() {
                    @Override
                    public void run() {
                        StartMeasureDialogIrTemp.super.dismiss();
    ...
    public void setIrtempTrend(String irtempTrend) {
        ...
        irtempTrend_tv.setText(irtempTrend);
    }

    public void setProgressBarMax(int length) {

        dialog_pb.setMax(length);
    }

    public void setProgress(int num) {

        dialog_pb.setProgress(num);
    }

    public abstract void dialogClose();
}
