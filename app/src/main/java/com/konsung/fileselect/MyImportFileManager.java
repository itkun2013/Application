...
import com.konsung.fragment.ConfigureFragment;
...
public class MyImportFileManager extends ListActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        buttonConfirm.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent data = new Intent(MyImportFileManager.this,
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (file.isDirectory()) {
            ...
            Intent data = new Intent(this, ConfigureFragment.class);
            Bundle bundle = new Bundle();
